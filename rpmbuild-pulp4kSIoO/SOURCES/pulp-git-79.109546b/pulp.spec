...
Name: pulp
Version: 2.6.0
Release: 0.1.alpha.git.79.109546b%{?dist}
Summary: An application for managing software content
Group: Development/Languages
License: GPLv2
URL: https://fedorahosted.org/pulp/
Source0: pulp-git-79.109546b.tar.gz
...
pushd server/pulp/server/webservices
...
pushd pulp/server/pulp/server/webservices
DJANGO_SECRET=$(python -c 'from django.utils.crypto import get_random_string; print get_random_string(50, "abcdefghijklmnopqrstuvwxyz0123456789!#%^*(-_=+_)")')
sed -i "s/replace-with-secret-key/${DJANGO_SECRET}/g" settings.py
popd
...
%{python_sitelib}/server/webservices/settings.py
%{python_sitelib}/%{name}/plugins/git
